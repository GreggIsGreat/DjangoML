...
def status(df):
    try:
        scaler = pickle.load(open("C:/Users/BIDA19-040/Downloads/django_restapi_aionline-master/DjangoAPI/Scaler.sav", 'rb'))
        model = pickle.load(open("C:/Users/BIDA19-040/Downloads/django_restapi_aionline-master/DjangoAPI/Prediction.sav", 'rb'))
